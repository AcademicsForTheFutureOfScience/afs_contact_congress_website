...
var ADDRESS_ERR_LOOKUP = {
  SERVER: 'There appears to be a problem with the server. Please try again, and if the problem persists, email save-science@mit.edu with the address you used so we can try and fix the issue.',
